...
#define INVADERS_DROP_BY 14 // pixel amount that invaders move down by
...
#define AMOUNT_TO_DROP_BY_PER_LEVEL 6	 //NEW How much farther down aliens start per new level
...
#define CHANCEOFBOMBDROPPING 10		 // Higher the number the rarer the bomb drop,
#define BOMB_HEIGHT 4
#define BOMB_WIDTH 2
#define MAXBOMBS 10 // Max number of bombs allowed to drop at a time

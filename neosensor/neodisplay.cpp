...
{
	Neodisplay::init(rotation, scl, sda, reset);
}

Neodisplay::Neodisplay() : U8G2()
{
	Neodisplay::init(U8G2_R0, U8X8_PIN_NONE, SCL, SDA);
}
...
void Neodisplay::init(const u8g2_cb_t *rotation, uint8_t scl, uint8_t sda, uint8_t reset = U8X8_PIN_NONE)
{
